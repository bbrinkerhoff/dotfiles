# Source: https://docs.folivora.ai/docs/plugins/floating-menu-widget
...
See [Xcode Bundle Plugins & Distribution for the full setup process.[PreviousStream Deck Plugins[NextAction Plugins
