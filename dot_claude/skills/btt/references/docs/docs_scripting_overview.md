# Source: https://docs.folivora.ai/docs/scripting/overview
...
- [Via JavaScript (Recommended as of BTT 3.333)

- [Via AppleScript

- [Via the custom btt:// URL Scheme

- [Via an integrated webserver
