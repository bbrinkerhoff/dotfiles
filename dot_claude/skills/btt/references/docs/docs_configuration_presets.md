# Source: https://docs.folivora.ai/docs/configuration/presets
...
![presets](/assets/images/presets-ba33d27caeb76296116d159f677eb1fd.jpg)
...
The most common way to switch between different presets is to enable/disable them as described above. However there are also predefined actions that allow you to activate specific presets. This can be quite useful, e.g. you can enable/disable specific presets using a keyboard shortcut.
...
![presets](/assets/images/switchpreset-93f9610324a8f21c08563044e1650ddd.jpg)


- **Toggle Preset Enabled/Disabled**


This action allows you to toggle the enabled/disabled state of the selected presets.[PreviousGlobal and App Specific Triggers[NextOther Settings

- [Accessing the Preset functionality

- [The Master Preset
- [Preset Standard functionality:
- [Switching between PresetsCommunity
