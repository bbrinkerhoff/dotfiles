# Source: https://docs.folivora.ai/docs/other-triggers/named-triggers
...
Named Triggers can be called using the [BetterTouchTool scripting interfaces using the **trigger_named** function. This allows you to configure any sequence of actions within BTT and trigger it using e.g. AppleScript or from within a floating webview.


**3.) Special Functionality / Multi Action Triggers**


Some triggers in BTT offer special functionality e.g. when being long pressed. However the BTT UI only allows to assign one action sequence to any given trigger. Named triggers allow you to jump to a different action sequence when the special functionality is triggered.
...
![named](/assets/images/named_triggers2-4e416917dd6490ffe523d5f367405035.png)
[PreviousText Selection Did Change Widgets[NextBTT as Default Browser / URL Based Triggers

- [Use Cases for Named Triggers
- [Defining named triggers:Community
