# Source: https://docs.folivora.ai/docs/stream-deck/overview
...
- [Standard button with various formatting options applied

- [Button with different actions for long press and short press

- [Button which repeats its actions while being pressed

- [Showing / changing buttons while holding other buttons

- [Showing buttons only on specific devices
...
![stream_deck_modes](/assets/images/stream_deck_1-1c93b52608685b76c51af56206a1f809.png)
...
![stream_deck_modes](/assets/images/stream_deck_plugin_mode-fdbd6235e9e371416cf78d5cac6c63b3.png)
...
![](/assets/images/streamdeck_folder_setup-3d62f3dcd8ed4e89a9428a9402febb7d.png)
[PreviousDevelopment Hints[NextStandard Button & Formatting
...
- [1.) Display Order
- [2.) Fixed Position
- [3.) Fixed Identifier in Plugin ModeCommunity
