# Source: https://docs.folivora.ai/docs/normal-mouse/troubleshooting

- [
- [Normal Mouse & Logitech
- Help: Mouse Buttons Not Recognized
...
See [Logitech Support for details on how to configure your Logitech Mouse with BetterTouchTool.
