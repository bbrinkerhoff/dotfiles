# Source: https://docs.folivora.ai/docs/scripting/url-scheme
...
**Important**: This feature is mostly useful if you want to trigger BetterTouchTool functionality from outside of BTT. If you want to use scripts inside of BTT (like in Touch Bar widgets or script actions) use the [JavaScript or [AppleScript scripting options.


BetterTouchTool allows to be controlled via a custom URL scheme (btt://).
On this page I'm briefly describing the various functions you can trigger via this URL scheme.


**Note:** Custom URL Schemes **can not return values** to the calling application/browser. If you need that (e.g. after executing a shell script in BTT from outside of BTT), please see the [Integrated Webserver.
...
![shared_secret](/assets/images/scripting_secret-7cf88199be5927faffbed56fc8662d02.jpg)
...
[PreviousUsing JavaScript (not JXA)[NextUsing HTTP Requests / Webserver
