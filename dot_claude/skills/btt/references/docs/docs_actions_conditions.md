# Source: https://docs.folivora.ai/docs/actions/conditions

- [
- [Actions
- Trigger Conditions & Conditional Activation Groups
...
![](/media/cag_setup1.png)


![](/assets/images/cag_setup2-1e2a6e19bc7a327074a67d72143828cc.png)
...
![](/media/trigger_conditions_1.png)


![](/media/trigger_conditions_2.png)
...
- 
![](/assets/images/trigger_conditions_3-ea40384aa7f6e792403d36e41daee67c.png)
...
- This gives information about the currently hovered UI element. You can view the current information by pressing the "UI Element Viewer" button. You can use the "contains" condition to check if the details shown in the "UI Element Viewer" contain a specific text.
...
- 
![](/assets/images/trigger_conditions_4-76b700635ea491e528a0e9598caf4ef1.png)
...
[/uploads/default/original/3X/1/d/1dbd95e86992737156bd8ba492cf2b805c05595c.mov
...
[PreviousManage Menu Bar Status Items[NextControl Action Sequence Flow

- [Configuring Conditional Activation Groups (CAGs):
- [Configuring Advanced Trigger Conditions (ATCs):
- [Available Variables
- [Example: Use one gesture for all your window snapping needsCommunity
