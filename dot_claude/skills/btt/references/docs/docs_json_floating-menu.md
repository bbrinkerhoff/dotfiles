# Source: https://docs.folivora.ai/docs/json/floating-menu

- [
- [JSON Definitions
- Floating Menu JSON Definitions
...
`
```
[PreviousJSON Definitions[NextTrigger JSON Definitions
