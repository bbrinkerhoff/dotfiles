# Source: https://docs.folivora.ai/docs/scripting/variables
...
Variables in BTT can be quite useful [when using AppleScript / JavaScript and the like.
...
![webserver](/assets/images/bttvariables-0148b5a2bce93e27970ba47d848b533f.png)
...
[PreviousCommand Line Interface[NextSimple JSON Format

- [Using Variables in BetterTouchTool
- [Dynamic Variables provided by BTT:
- [Advanced Trigger Condition VariablesCommunity
