# Source: https://docs.folivora.ai/docs/scripting/useful-scripts
...
## Execute different actions when executing once and when executing twice in quick succession:[​
...
## Send A Keyboard Shortcut Via BTT From Within An AppleScript[​
...
`
```
[PreviousSimple JSON Format[NextManage Menubar Status Items

- [Execute different actions when executing once and when executing twice in quick succession:
- [Send A Keyboard Shortcut Via BTT From Within An AppleScriptCommunity
