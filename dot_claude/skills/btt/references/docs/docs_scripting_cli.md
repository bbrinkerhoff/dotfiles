# Source: https://docs.folivora.ai/docs/scripting/cli
...
![alt text](/assets/images/cli_preset_selection-5e6dbaaafd51f63a4b7401c0c8b2a5ea.png)


![alt text](/assets/images/cli_keyboard_shortcuts-033512276c445de3f97d0f0edc325f60.png)
...
- The `import_preset` command shows a security warning unless the user has opted to always allow imports

- External scripting must be enabled for non-webserver requests
[PreviousUsing HTTP Requests / Webserver[NextAvailable Standard Variables
