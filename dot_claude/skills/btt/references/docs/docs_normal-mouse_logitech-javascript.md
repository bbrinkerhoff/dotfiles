# Source: https://docs.folivora.ai/docs/normal-mouse/logitech-javascript
...
`
```
[PreviousLogitech Mouse Support[NextScroll Modifiers
...
- [logitech_stop_pairing()
- [Error Handling
- [Complete Example: Mouse Control PanelCommunity
