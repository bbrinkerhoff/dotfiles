# Source: https://docs.folivora.ai/docs/keyboard-shortcuts/overview
...
![keyboardshortcutsetup](/assets/images/keyboard_shortcut_setup-2f9212d3ea07abc4a13ad81e071be588.jpg)


# Advanced Shortcut Settings


For most use cases recording a shortcut is simple and straightforward. However there are various advanced options, e.g. to show a HUD overlay, to differentiate between left/right modifier keys, set repeat rates etc.


## Modifier Key Only Shortcuts?[​


A shortcut in BTT always requires at least one normal, non modifier, key. However BTT also supports any other key combination via [Key Sequences. For example if you want to trigger something while pressing only one or more modifier keys (cmd, ctrl, shift, fn, option) you can set up a Key Sequence for this.
See [Key Sequences
...
To prevent this, you can check the "prevent recursive triggers" checkbox.[PreviousWindow Moving and Resizing[NextDefining a Hyper Key
...
- [Trigger on key-down / key-up
- [Key Repeat
- [Prevent recursive triggersCommunity
