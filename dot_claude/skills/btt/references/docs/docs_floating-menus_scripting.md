# Source: https://docs.folivora.ai/docs/floating-menus/scripting
...
Starting with BetterTouchTool 4.764 you can use the new [Simple JSON Format in combination with JavaScript to dynamically retrieve the contents of a floating menu.


Have a look at [Simple JSON Format for details on how to use it.
...
You can either use AppleScript like this:
...
The easiest way to update the content or appearance of a floating menu is to use the predefined action "Update Floating Menu Item Properties" action.
...
To make escaping easier with AppleScript, BTT allows to use JSON5 in addition to standard JSON.


AppleScript Example With Item UUID:
...
AppleScript Example With Menu Name And Item Name:
...
`
```
[PreviousItem Types[NextUpdating Item Properties
...
- [Setting The Value Of An Item
- [Loading Content Into A Web View Item or Executing JavaScript
- [Get dropped item valuesCommunity
