# Source: https://docs.folivora.ai/docs/webview/scripts
...
`
```
[PreviousCall BTT Functions from the WebView[NextShortcuts from the Shortcuts App

- [Running AppleScripts from the WebView
- [Running Shell Scripts from the WebViewCommunity
