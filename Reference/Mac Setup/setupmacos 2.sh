...
# Host name/Computer name variable (keep to 15 char for less for netbios to work)
# MACHINENAME='MacBook'

# Default Terminal theme
termTheme="Solarized Dark"
terminalTheme="${termTheme} xterm-256color"
itermTheme="${termTheme}.itermcolors"
...
sudoerFile=$(mktemp)
echo '%admin          ALL=(ALL)      NOPASSWD:ALL' >> ${sudoerFile}
chmod 0600 ${sudoFile}
chown root:wheel ${sudoFile}
sudo mv ${sudoFile} /etc/sudoers.d/admins
...
if [[ -e "${resourceDir}/Wallpaper.jpg" ]]
then
	rm -rf ~/Library/Application Support/Dock/desktoppicture.db
	sudo rm -rf /System/Library/CoreServices/DefaultDesktop.jpg
	cp -pv "${resourceDir:-.}/Wallpaper.jpg" "${HOME}/Pictures/Wallpaper.jpg"
...
xattr -d com.apple.quarantine "${resourceDir:-.}/${terminalTheme}.terminal"
xattr -d com.apple.quarantine "${resourceDir:-.}/${itermTheme}"
osascript <<EOD
...
tell application "Terminal"
  ...
  do shell script "open '${scriptDir:-.}/resources/" & themeName & ".terminal'"
...
if [[ -e "${resourceDir:-.}/Preferences.sublime-settings" ]]
then
	cp -r "${resourceDir:-.}/Preferences.sublime-settings" ~/Library/Application\ Support/Sublime\ Text*/Packages/User/Preferences.sublime-settings 2> /dev/null
fi
